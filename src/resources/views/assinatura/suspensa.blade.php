...
<head>
    ...
    <title>Pagamento recusado — Payog</title>
...
<body class="min-h-screen bg-gray-50 flex items-center justify-center p-4">
    <div class="max-w-md w-full text-center">
        ...
        <h1 class="text-2xl font-bold text-gray-900 mb-2">Pagamento recusado</h1>
        <p class="text-gray-500 mb-8 leading-relaxed">
            Tentamos cobrar sua assinatura mas o pagamento foi recusado.
            Atualize seu método de pagamento para reativar o acesso.
        </p>
        ...
        <div class="bg-white rounded-xl border border-red-100 p-5 mb-6 text-left">
            <div class="flex items-center gap-3 mb-4">
                <div class="w-2 h-2 rounded-full bg-red-400"></div>
                <span class="text-sm font-medium text-gray-700">Assinatura suspensa</span>
            </div>
            <div class="space-y-2 text-xs text-gray-500">
                ...
                <div class="flex items-center gap-2">
                    ...
                    O acesso será reativado imediatamente após o pagamento
                </div>
            </div>
        </div>
